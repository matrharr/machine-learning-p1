...
from decision_tree.decision_tree_train import decision_tree
...
classifiers = [
    (dt, 'Decision Tree', 'decision_tree_model'),
    # (knn, 'K Nearest Neighbors', 'knn'),
    # (b, 'Boosting', 'boosting'),
    # (nn, 'Neural Network', 'neural_network'),
...
# col_trans, bankruptcy = loader.load_data()
# y_col = 'Bankrupt?'
loader = DataLoader('loan')
col_trans, bankruptcy = loader.load_data()
y_col = 'loan_default'

for clf, label, name in classifiers:
    '''
    pipeline
    '''
